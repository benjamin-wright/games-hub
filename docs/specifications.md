...
| [api-gateway](../apps/platform/api-gateway) | A gateway application that accepts WebSocket connections and passes events through to a NATS-based messaging queue. |
